...
func addLocalDirConfOptions(app *v1beta2.SparkApplication) ([]string, error) {
	...
	if app.Spec.Driver.VolumeMounts != nil {
		driverMutateVolumeMounts, driverLocalDirConfConfOptions := filterMutateMountVolumes(app.Spec.Driver.VolumeMounts, common.SparkKubernetesDriverVolumesPrefix, sparkLocalVolumes)
	...
	if app.Spec.Executor.VolumeMounts != nil {
		executorMutateVolumeMounts, executorLocalDirConfConfOptions := filterMutateMountVolumes(app.Spec.Executor.VolumeMounts, common.SparkKubernetesExecutorVolumesPrefix, sparkLocalVolumes)
...
func getResourceLabels(app *v1beta2.SparkApplication) map[string]string {
	labels := map[string]string{common.LabelSparkAppName: app.Name}
